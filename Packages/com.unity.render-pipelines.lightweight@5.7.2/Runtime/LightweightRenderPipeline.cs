    ...
    public sealed partial class LightweightRenderPipeline : RenderPipeline
    {
        ...
        static void InitializeShadowData(LightweightRenderPipelineAsset settings, NativeArray<VisibleLight> visibleLights, bool mainLightCastShadows, bool additionalLightsCastShadows, out ShadowData shadowData)
        {
            ...
            for (int i = 0; i < visibleLights.Length; ++i)
            {
                ...
                if (light.type == LightType.Directional && data)
                {
                    settings.shadowDistance = data.shadowDistance;
                    settings.shadowLayerDistance = data.shadowLayerDistance;
                    settings.shadowLayerDistanceSurport = data.shadowLayerDistanceSurport;
                }
            }
            ...
            shadowData.requiresScreenSpaceShadowResolve = shadowData.supportsMainLightShadows && supportsScreenSpaceShadows && settings.supportSSSM;
            ...
            shadowData.ssShadowDownSampleSize = settings.SSSMDowmsampleSize;
            shadowData.supportsSemiTransShadow = settings.supportsSemiTransShadows;
            shadowData.shadowmapDepthBufferBits = 16;
            shadowData.shadowLayerDistance = settings.shadowLayerDistance;
            shadowData.surportsLayerDistance = settings.shadowLayerDistanceSurport;
            shadowData.maxShadowDistance = settings.shadowDistance;
        }
        ...
        public static void SetupPerCameraShaderConstants(CameraData cameraData)
        {
