...
namespace UnityEngine.Rendering.LWRP
{
    ...
    public class LightweightRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] HDRFormat m_HDRformat = HDRFormat.RGB111110;
        ...
        bool m_ShadowLayerDistanceSurport = false;
        float[] m_ShadowLayersDistance = new float[32];
        ...
        [SerializeField] bool m_SemiTransShadowsSupported = false;
        [SerializeField] bool m_SSSM = false;
        [SerializeField] int m_SSSMDownsampleSize = 1;
        ...
        public HDRFormat HDRFormatSetting
        {
        ...
        public bool shadowLayerDistanceSurport
        {
            ...
            set { m_ShadowLayerDistanceSurport = value; }
        }
        public float[] shadowLayerDistance
        {
            get { return m_ShadowLayersDistance; }
            set { m_ShadowLayersDistance = value; }
        }
        ...
        public bool supportsSemiTransShadows
        {
            get { return m_SemiTransShadowsSupported; }
        }

        public bool supportSSSM
        {
            get { return m_SSSM; }
        }

        public int SSSMDowmsampleSize
        {
            get { return m_SSSMDownsampleSize; }
        }
