Shader "Hidden/HDRP/GGXConvolve"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.lightweight/Editor/Light/GGXConvolution.cs.hlsl"
            ...
            float4 Frag(Varyings input) : SV_Target
            {
                ...
                float3 V = N;
				//hack for now since there is bug.
                float perceptualRoughness = HackMipmapLevelToPerceptualRoughness(_Level);
