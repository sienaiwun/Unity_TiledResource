...
namespace UnityEditor.Rendering.LWRP
{
    ...
    public class LightweightRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent hdrFormat = EditorGUIUtility.TrTextContent("HDR 全局格式", "Controls the global HDR Format settings.");
			...
			public static GUIContent supportSemitransShadows = EditorGUIUtility.TrTextContent("Semitrans Shadows", "Semitransparent Shadows.");
            public static GUIContent supportSMDownsample = EditorGUIUtility.TrTextContent("SS Shadowmap", "SS Shadowmap");
            public static GUIContent SMDownsampleSize = EditorGUIUtility.TrTextContent("Downsample Size", "SS Downsample Size");
            // Advanced settings
        ...
        SerializedProperty m_HDR_format;
        ...
        SerializedProperty m_SemiTransShadowsSupportedProp;
        SerializedProperty m_SSShadowsDownsampleSupportedProp;
        SerializedProperty m_SSShadowsDownsampleSizeProp;
        ...
        void DrawQualitySettings()
        {
            ...
            if (m_QualitySettingsFoldout.value)
            {
                ...
                EditorGUILayout.PropertyField(m_HDR_format, Styles.hdrFormat);
