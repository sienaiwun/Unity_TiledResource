...
namespace UnityEditor.Rendering.LWRP
{
    ...
    class LightweightRenderPipelineCameraEditor : CameraEditor
    {
        ...
        internal class Styles
        {
            ...
            public static GUIContent hdrFormatContent = EditorGUIUtility.TrTextContent("HDR ∏Ò Ω", "High Dynamic Range Format.", (Texture)null);
            ...
            public static GUIContent[] cameraHDROverideType =
            {
                new GUIContent("FP16"),
                new GUIContent("RGB111110"),
                new GUIContent("Use Pipeline Settings"),
            };

            public static int[] cameraHdrOption = { 0, 1, 2 };
        ...
        SerializedProperty m_AdditionalCameraDataHDRFromatDataProp;
        ...
        void DrawHDRFormat()
        {
            if (m_has_addtional_data)
            {
                ...
                Rect hdrControlRect = EditorGUILayout.GetControlRect(true);
                EditorGUI.BeginProperty(hdrControlRect, Styles.hdrFormatContent, m_AdditionalCameraDataHDRFromatDataProp);
                int selectedValue = (int)m_AdditionalCameraDataHDRFromatDataProp.intValue;
                m_AdditionalCameraDataHDRFromatDataProp.intValue = EditorGUI.IntPopup(hdrControlRect, Styles.hdrFormatContent, m_AdditionalCameraDataHDRFromatDataProp.intValue, Styles.cameraHDROverideType, Styles.cameraHdrOption);
