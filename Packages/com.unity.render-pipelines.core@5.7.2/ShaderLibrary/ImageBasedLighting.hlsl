...
#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/Sampling/Sampling.hlsl"
    ...
    #define UNITY_SPECCUBE_LOD_STEPS 9
#endif
...
// hack 高粗糙度部分保持0.125一级，光滑部分让整体更光滑
real HackMipmapLevelToPerceptualRoughness(real mipmapLevel)
{
	float hackRougnhess;
	switch (mipmapLevel)
	{
	case 1: hackRougnhess = 0.08; break;
	case 2: hackRougnhess = 0.17; break;
	case 3: hackRougnhess = 0.26; break;
	case 4: hackRougnhess = 0.4; break;
	case 5: hackRougnhess = 0.5; break;
	case 6: hackRougnhess = 0.625; break; // UNITY_SPECCUBE_LOD_STEPS
	case 7: hackRougnhess = 0.75; break;
	case 8: hackRougnhess = 0.875; break;
	case 9: hackRougnhess = 0.99; break;
	}
	return hackRougnhess;
}
...
uint GetIBLRuntimeFilterSampleCount(uint mipLevel)
{
	...
	switch (mipLevel)
	{
		...
		case 7: sampleCount = 89; break;
		case 8: sampleCount = 89; break;
		case 9: sampleCount = 89; break;
		#endif
	}
